 ...
 * shared at build time — this file is duplicated in kinetic-svg with its own
...
export const CURRENT_SECTION = 'text'

export const GITHUB_URL = 'https://github.com/aowshad/kinetic'
